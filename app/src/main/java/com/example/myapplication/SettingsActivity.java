...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        securityQuestionBtn = (Button) findViewById(R.id.settings_security_questions_btn);
    ...
    {
        if(TextUtils.isEmpty(fullNameEditText.toString()))
        {
            Toast.makeText(this,"Name is Mandatory",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(userPhoneEditText.toString()))
        {
            Toast.makeText(this,"Phone Number is Mandatory",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(addressEditText.toString()))
        {
